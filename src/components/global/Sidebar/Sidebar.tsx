        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                  ...
                  return (
                    <React.Fragment>
                      <Link
                        href="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4
                        ${pathname.includes("master") || pathname === "/auth/register" && "bg-graydark dark:bg-meta-4"}`
                        }
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white
                                ${pathname === "/master/data-user" || pathname === "/auth/register" && "text-white"}`}
                            >Data User</Link>
                          </li>
                          <li>
                            <Link
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        ...
                        <div className="text-title-ss">Data Kependudukan</div>
                        <IoIosArrowDown size={20} className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open && "rotate-180"}`} />
                      </Link>
                      <div className={`translate transform overflow-hidden ${!open && "hidden"}`}>
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
              ...
              {/* <!-- Menu Item Data Kependudukan OPD --> */}
              <li>
                <Link
                  href="#"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4
                ...
                >
                  <FaPeopleRoof size={28} />
                  <div className="text-title-ss">Data Kependudukan Perangkat Daerah</div>
                </Link>
              </li>
            </ul>
          </div>
